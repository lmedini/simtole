...
//		k = Configuration.getInt(prefix + "." + PAR_DEGREE);
	...
	public void wire(Graph g) {
		...
		//String pathRelative = "G:"+ slash +"download"+slash+"works"+slash+"TER"+slash+"peersim-1.0"+slash+"peersim-1.0.2"+slash+"peersim-1.0.4";
		String pathRelative = ParamLoader.basePath;
		String URL_XML_TOPOLOGY = pathRelative+"."+ slash +"out";
		String nameNetwork = Configuration.getString(NETWORK_NAME);
		String urlXML = URL_XML_TOPOLOGY + slash + nameNetwork + ".xml";

		GraphFactory.unWireTopology(g,Configuration.getInt(ParamLoader.NB_PEER));
		GraphFactory.wireXMLTopology(g, urlXML);
	}
}
