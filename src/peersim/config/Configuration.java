...
//MODIFICATION LIONEL pour pouvoir faire tourner plusieurs simulations à la suite :
//Supprimé le test qui lève une exception si la config a déjà été lue dans les 2 méthodes setConfig()
...
{
	/* MODIF LIONEL : pour pouvoir faire tourner plusieurs simulations à la suite
	if (config != null) {
