...
public int lookupPid(String protname)
{
	...
	if (ret == null) {
/*		System.out.println("Protname : " + protname);
		System.out.println("Config : " + Configuration.PAR_PROT);
		System.out.println("Autre : " + Configuration.PAR_MAXDEPTH);
		Set<String> keys = protocols.keySet();
		for (Iterator i = keys.iterator(); i.hasNext();) {
			String tmp = (String) i.next();
			System.out.println("*Protocol("+ tmp +") = " + protocols.get(tmp));
		}
*/		
...
// Décommenter pour ne pas avoir d'erreurs sur IllegalParameterException...
