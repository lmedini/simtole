...
/**
 * Initialization, taken out from Simulate (Lionel)
 */
public static void init(String args) throws IOException {
	// Chargement de la config (ne doit être fait qu'une fois sous peine de runtime exception
	System.err.println("Simulator: loading configuration");
	Configuration.setConfig( new ParsedProperties(args) );

	// Initialisation du PrintWriter de sortie
	...
	try {
		...
		for(int k=0; k<exps; ++k)
		{
			...
			System.err.print("Simulator: initializing experiment "+k);
