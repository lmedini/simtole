...
public interface Linkable extends Cleanable {
	...
	*/
	...
	/**
	 * replace neighbor at ith place of neighbor
	 * @param i
	 * @param newNeighbour
	 */
	public void setNeighbor(int i, Node newNeighbour);

	/**
	 * Added method to the basic PeerSim distribution. Removes a node from the neighborhood of the current node
	 * @param neighbour Node to be removed
	 * @return true if neighbour was in the node's neighborhood and was actually removed,
	 * false if it was not in its neighborhood, or ends with an exception in other cases.
	 */
